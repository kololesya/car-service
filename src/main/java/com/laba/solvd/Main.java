...
public class Main {
    ...
    public static void main(String[] args) throws CarServiceException {
        ...
        try {
            ...
            logger.info("Is {} service date valid? {}", car2.getModel(), isValidDate(car2.getServiceDate()));
...
//            carService.removeDepartment(tireDepartment.getName());
//
...
//            inspectionHonda.performInspection(car2);  // Fixed to use the correct object
//            double y = inspectionHonda.calculateCost();
//            logger.info("Total inspection cost for both cars: {}", x + y);
            ...
            logger.info("Order Items: {}", order1.getOrderItems());
