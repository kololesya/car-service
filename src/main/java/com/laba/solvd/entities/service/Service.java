...
public abstract class Service {
    ...
    public Service(String serviceName, LocalDate serviceDate, Car car) {
        if (serviceName == null || serviceName.trim().isEmpty()) {
            ...
            throw new InvalidDataException("Service name cannot be null or empty.");
        }
        if (serviceDate == null) {
            logger.error("Invalid serviceDate: {}", serviceDate);
            throw new InvalidDataException("Service date cannot be null.");
        }
        if (car == null) {
    ...
    public void setServiceName(String serviceName) {
        if (serviceName == null || serviceName.trim().isEmpty()) {
            ...
            throw new InvalidDataException("Service ID cannot be null or empty.");
        }
        this.serviceName = serviceName;
